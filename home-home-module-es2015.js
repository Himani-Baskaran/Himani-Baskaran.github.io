...
let HomePage = class HomePage {
    ...
    ngOnInit() {
        this.nopages = [
            { name: 'Blog', desc: 'A few thoughts put into words', imgUrl: '/assets/9.jpg', Url: 'blog' },
            { name: 'Photography', desc: 'Captured, not what I saw, but what I felt', imgUrl: '/assets/2.jpg', Url: 'photo' },
            { name: 'About', desc: 'An insight into me', imgUrl: '/assets/6.jpg', Url: 'about' }
        ];
    }
};
