...
let PhotoPage = class PhotoPage {
    ...
    ngOnInit() {
        this.photos = [
            { name: 'Serenity', desc: 'My first visit to Mangalore beaches', imgUrl: '/assets/1.jpg', },
            { name: 'Dear one', desc: 'One of the many wonders in Campus', imgUrl: '/assets/2.jpg' },
            { name: 'Dear departed', desc: 'A scene at the Egmore railway station', imgUrl: '/assets/3.jpg' },
            { name: 'Fallen', desc: 'Simple yet beautiful', imgUrl: '/assets/4.jpg' },
            { name: 'Silhouette', desc: 'A macaque looking so ethereal', imgUrl: '/assets/5.jpg' }
        ];
    }
};
