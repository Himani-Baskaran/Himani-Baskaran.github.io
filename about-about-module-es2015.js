...
let AboutPage = class AboutPage {
    ...
    ngOnInit() {
        this.edu = [
            { name: 'Under Graduate', desc: 'I\'m currently pursuing my B.Tech in IIT Madras ', imgUrl: '/assets/7.png' },
            { name: 'Primary and Secondary education', desc: 'At R S Krishnan Higher Secondary School', imgUrl: '/assets/8.jpg' },
            { name: 'Higher Secondary education', desc: 'At Maharishi International Residential School', imgUrl: '/assets/8.jpg' }
        ];
    }
};
